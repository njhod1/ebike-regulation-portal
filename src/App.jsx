...
/**
 * PENALTY GRID COMPONENT - Fixed overlap bug from Image 6
 */
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden">
      {/* FINAL PRINT FIX: Shortened to 275mm to ensure single page (Image 1 fix) */}
      <style dangerouslySetInnerHTML={{ __html: `
        @media print {
          ...
          .print-container { 
            ...
            height: 275mm !important; /* Shorter than 297mm to prevent blank 2nd page break */
